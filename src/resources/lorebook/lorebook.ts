// src/resources/lorebook/lorebook.ts
import { cloneDeep } from "lodash-es";
import { ExpressionEngine } from "@/lib/ExpressionEngine";
import type {
	ApiReadyMessage,
	ResolvedInterval,
} from "@/resources/chat/chat.types";
import type { EnhancedApiReadyContext } from "@/resources/chat/EnhancedApiReadyContext";
...
export { useLorebookResources } from "./useLorebookResources";
export { default as LorebookManager } from "./LorebookManager.vue";
export type { LorebookResourceItem } from "./useLorebookResources";
...
export const LorebookDefinition = {
	...
	managingMethod: {
		...
		renderingMethod: LorebookManager,
	},
	managingComposable: useLorebookResources,
};
