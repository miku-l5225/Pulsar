// src/resources/preset/preset.ts
...
export { usePresetResources } from "./usePresetResources";
export { default as PresetManager } from "./PresetManager.vue";
export type { PresetResourceItem } from "./usePresetResources";
...
export const PresetDefinition = {
  ...
  managingMethod: {
    ...
    renderingMethod: PresetManager,
  },
  managingComposable: usePresetResources,
