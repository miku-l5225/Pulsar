...
export { useChatResources } from "./useChatResources";
export { default as ChatManager } from "./ChatManager.vue";
export type { ChatResourceItem } from "./useChatResources";
...
export const ChatDefinition: SchemaDefinition<RootChat> = {
  ...
  managingMethod: {
    ...
    renderingMethod: ChatManager,
  },
  managingComposable: useChatResources,
};
