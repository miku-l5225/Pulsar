// src/resources/setting/setting.schema.ts
import {
  Blocks,
  Bot,
  History,
...
export function getSettingSchema(): Schema {
  return {
          ...
          content: [
            // 2. 添加主题选择器
            {
              ...
              content: [
                {
                  title: "配色方案",
                  description: "选择应用程序的整体配色风格。",
                  component: "ThemeSelector",
                  // 注意：因为我们直接操作 useStorage，不需要 accessChain 绑定到 setting.json
                  accessChain: "",
                },
              ],
            },
    ...
    components: { ExecutableStringEditor, DefaultModelSelector, ThemeSelector },
  };
}
